...
const getEmpAttendance: ValidatedEventAPIGatewayProxyEvent<typeof schema> = async (event) => {
  ...
  try {
   ...
   // console.log(Employee);
    ...
    return formatJSONResponse({
      ...
      attendance: Employee.Item.attendance
    });
  } catch (error) {
    return formatJSONResponse({
...
export const main = middyfy(getEmpAttendance);
